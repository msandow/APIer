...
search =
  ...
  'VisionIT', 'Techsophy', 'Mahindra', 'Zentek', 'Intelliswift', 'k-tek', 'tekvalley']
  #
  ...
  blacklist: []
  filterTitles: ['java[\s)]', 'mobile', 'performance', 'quality', 'director', 'android', 'ios', 'c++', 'flash', 'aggregation' ,'test']
