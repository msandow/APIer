...
search =
  ...
  'VisionIT', 'Techsophy', 'Mahindra', 'Zentek', 'Intelliswift', 'k-tek', 'tekvalley', 'gdh consulting', 'autodesk', 'hire']
  #
  ...
  'automation', 'network', 'administrator', 'virtual', 'QA', 'associate', 'principal']
